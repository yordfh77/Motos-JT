...
const MotorcycleFormPage: React.FC = () => {
    ...
    const handleRemoveExistingImage = async (imageUrl: string) => {
        if (!window.confirm("¿Seguro que quieres eliminar esta imagen? Esta acción es permanente.")) return;
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <FormSection title="Multimedia">
                     <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2">Puedes seleccionar varias imágenes a la vez. La primera será la principal.</p>
