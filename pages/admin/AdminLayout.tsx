...
const AdminLayout: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const activeNavLinkClasses = "bg-[#00bfa5] text-white";

    const sidebarContent = (
        <>
            <div className="p-4">
                <h1 className="text-2xl font-black italic uppercase text-white tracking-wide">Ayocet <span className="text-[#00bfa5] pl-1">/ JT</span></h1>
                ...
                <header className="flex justify-between items-center p-4 bg-white border-b">
                    ...
                    <div className="flex items-center space-x-4">
                        <span className="text-sm text-gray-600 hidden md:block">{user?.email}</span>
                         <a href="/#" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-[#00bfa5] hover:text-blue-700 transition-colors flex items-center space-x-1.5">
