...
const MotorcycleCard: React.FC<{ moto: Motorcycle }> = ({ moto }) => (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:-translate-y-2 transition-all duration-300 group border border-gray-100 hover:shadow-2xl">
        <div className="relative h-56 overflow-hidden">
            ...
            {moto.destacada && (
                <span className="absolute top-3 right-3 bg-yellow-400 text-gray-900 text-xs font-black italic px-3 py-1 rounded-full shadow-md uppercase">Destacada</span>
            )}
        </div>
        ...
        <div className="p-5 relative">
            ...
            <h3 className="text-2xl font-black italic text-gray-800 truncate uppercase tracking-tight mb-2">{moto.nombre}</h3>
        ...
        <PublicLayout>
            ...
            <section className="relative h-[75vh] flex items-center justify-center text-white text-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black">
                    <img src="https://picsum.photos/seed/motorcycle_racing/1920/1080" alt="Hero BG" className="w-full h-full object-cover opacity-60" />
                </div>
                <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black/80"></div>
                
                <div className="relative z-10 p-4 flex flex-col items-center">
                    <h1 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter mb-2 leading-none drop-shadow-2xl">
                        Catálogo <br/><span className="text-[#00bfa5]">Motos JT</span>
                    </h1>
                    <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto font-bold italic tracking-wide text-gray-200 drop-shadow-md">
                        Tu pasión en dos ruedas. Encuentra tu modelo ideal hoy mismo.
                    </p>
                    <Link to="/catalogo" className="bg-[#dc2626] text-white font-black italic uppercase tracking-wider py-4 px-10 rounded-full text-lg hover:bg-red-700 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(220,38,38,0.5)] border-2 border-white/20">
            ...
            <section className="py-16 bg-white relative z-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="w-24 h-2 bg-[#00bfa5] mx-auto mb-12 transform -skew-x-12"></div>

                    {loading ? <Spinner /> : (
                         <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                            {categories.map(category => (
                                <Link key={category.id} to={`/catalogo?categoria=${encodeURIComponent(category.nombre)}`}
                                    className="group relative rounded-xl overflow-hidden text-center transform hover:-translate-y-2 transition-all duration-300 shadow-lg border-2 border-transparent hover:border-[#00bfa5]">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#002d40]/90 to-transparent flex items-end justify-center p-4">
                                        <h3 className="text-white font-black italic uppercase text-lg tracking-wide group-hover:text-[#00bfa5] transition-colors">{category.nombre}</h3>
                                    </div>
                                </Link>
                            ))}
                        </div>
            ...
            <div className="relative -mb-1 z-20">
                 <svg className="w-full h-16 md:h-32" viewBox="0 0 1440 320" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#00332a" fillOpacity="1" d="M0,96L48,112C96,128,192,160,288,186.7C384,213,480,235,576,213.3C672,192,768,128,864,128C960,128,1056,192,1152,213.3C1248,235,1344,213,1392,202.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                </svg>
            </div>

            {/* Featured Models Section (Dark Green) */}
            <section className="py-20 bg-[#00332a] relative">
                {/* Background Pattern */}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                         <h2 className="text-4xl md:text-6xl font-black italic uppercase text-white tracking-tighter mb-2" style={{WebkitTextStroke: '1px transparent'}}>
                            Modelos <span className="text-[#00bfa5]">Destacados</span>
                        </h2>
                    ...
                    <div className="text-center mt-16">
                        <Link to="/catalogo" className="inline-block border-2 border-[#00bfa5] text-[#00bfa5] font-black italic uppercase tracking-wider py-3 px-10 rounded-full text-lg hover:bg-[#00bfa5] hover:text-[#00332a] transition-all duration-300">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 md:p-12 shadow-xl border-2 border-gray-100 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#00bfa5] opacity-10 rounded-bl-full"></div>
                        ...
                        <div className="flex justify-center">
                            <Link to="/catalogo" className="bg-[#002d40] text-white font-black italic py-4 px-10 rounded-full text-lg hover:bg-[#00bfa5] hover:shadow-lg transition-all duration-300 uppercase tracking-wide">
                               ¡Ver Motos Ahora!
                            </Link>
                        </div>
                    </div>
